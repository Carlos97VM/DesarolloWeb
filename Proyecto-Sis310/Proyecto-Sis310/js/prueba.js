...
function TablaPMS(){
   ...
   htm="<table border=0>";
         ...
         {
            htm+='<tr>'+
                     '<td><label><input type="text" id="per'+i+'" name="per" class="form-control is-valid"></label></td>'+
                     '<td><label><input type="number" id="dem'+i+'" name="dem" class="form-control is-valid" value=0"></label></td>'+
                  '</tr>';
         }
         htm+="</table>";
         htm+='<div class="container-fluid">';
         htm+='<button type="button" class="btn btn-primary col-11" data-toggle="modal" data-target="#exampleModalLong" onclick="Calcular_PMS()">Calcular</button>'
         htm+='<div class="row">';
